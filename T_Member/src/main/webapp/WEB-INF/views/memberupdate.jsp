...
<script>
	function updatefn() {
		...
		var password = '${member123.tpassword}'; //DB에서 가져온 비번
...
<body>
	...
	<form action="updateprocess" method="post" name="updateform">
		아이디: <input type="text" name="tid" value="${member123.tid}" readonly ><br>
		비밀번호: <input type="text" name="tpassword" id="pwd"><br>
		이름: <input type="text" name="tname" value="${member123.tname}" readonly ><br>
		이메일: <input type="text" name="temail" value="${member123.temail}"><br>
		이메일: <input type="text" name="temail" value="${member123.temail}"><br>
		이메일: <input type="text" name="temail" value="${member123.temail}"><br>
